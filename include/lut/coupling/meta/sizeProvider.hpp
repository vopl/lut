...
namespace lut { namespace hiddenImpl {
    ...
    template <> struct sizeProvider<::lut::coupling::meta::impl::Enum> { static const std::size_t _value =  3;};
    template <> struct sizeProvider<::lut::coupling::meta::impl::EnumValue> { static const std::size_t _value =  0;};
    template <> struct sizeProvider<::lut::coupling::meta::impl::Iface> { static const std::size_t _value =  4;};
    ...
    template <> struct sizeProvider<::lut::coupling::meta::impl::Scope> { static const std::size_t _value =  2;};
    template <> struct sizeProvider<::lut::coupling::meta::impl::Set> { static const std::size_t _value =  0;};
    template <> struct sizeProvider<::lut::coupling::meta::impl::Struct> { static const std::size_t _value =  4;};
    template <> struct sizeProvider<::lut::coupling::meta::impl::Type> { static const std::size_t _value =  0;};
    template <> struct sizeProvider<::lut::coupling::meta::impl::Variant> { static const std::size_t _value =  4;};
}}
