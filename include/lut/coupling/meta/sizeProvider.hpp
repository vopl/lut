...
namespace lut { namespace hiddenImpl {
    ...
    template <> struct sizeProvider<::lut::coupling::meta::impl::Entity> { static const std::size_t _value =  0;};
    ...
    template <> struct sizeProvider<::lut::coupling::meta::impl::Integer> { static const std::size_t _value =  0;};
    ...
    template <> struct sizeProvider<::lut::coupling::meta::impl::Real> { static const std::size_t _value =  0;};
    ...
    template <> struct sizeProvider<::lut::coupling::meta::impl::String> { static const std::size_t _value =  0;};
