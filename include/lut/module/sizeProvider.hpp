...
namespace lut { namespace himpl {
    template <> struct sizeProvider<::lut::module::impl::Controller> { static const std::size_t _value =  0;};
    template <> struct sizeProvider<::lut::module::impl::Place> { static const std::size_t _value =  0;};
}}
